                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                     <form name="P2" method="post" Action="sim_report_userkit_aggiungi.asp" class="form-horizontal" onsubmit="return controllo()">
                                      <fieldset>
                                          ...
                                          <div class="controls">
                                            <input name="sim_report_periodo_dal" id="demo1" type="text" size="25"><a href="javascript:NewCal('demo1','ddMMyyyy')"><img src="images/cal.gif" width="20" height="20" border="0" alt="Pick a date"></a>
                                          </div>
                                        </div>
                                          <div class="control-group">
                                          <label class="control-label" for="focusedInput">al: </label>
                                          <div class="controls">
                                            <input name="sim_report_periodo_al" id="demo1" type="text" size="25"><a href="javascript:NewCal('demo1','ddMMyyyy')"><img src="images/cal.gif" width="20" height="20" border="0" alt="Pick a date"></a>
                                          </div>
                                          </div>
