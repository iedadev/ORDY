...
sc= "SELECT Count(Step1.NUMORD) AS tot FROM (SELECT DISTINCT NUMORD FROM ORD_COMPLETATI WHERE EMAIL< 2 GROUP BY NUMORD ) AS Step1;"
Set rsc = dbConn.Execute(sc)

'mail da inviare per ordini in stato incompleti ma pagati
s="SELECT Count(Step1.NUMORD) AS tot FROM (SELECT DISTINCT NUMORD FROM ORD_Richieste  WHERE STATOORDINE =0 AND DATAPAGAMENTO IS NOT NULL) AS Step1"
Set rs = dbConn.Execute(s)

'mail da inviare per ordini in stato incompleti in attesa di pagamento
si="SELECT Count(Step1.NUMORD) AS tot FROM (SELECT NUMORD FROM ORD_Richieste  WHERE STATOORDINE =2 AND Datapagamento IS NULL GROUP BY NUMORD) AS Step1"
Set rsi = dbConn.Execute(si)

'mail da inviare per ordini presi in carico
spc="SELECT Count(Step1.NUMORD) AS tot FROM (SELECT DISTINCT NUMORD FROM ORD_Richieste  WHERE INCARICO =1  GROUP BY NUMORD) AS Step1"
...
<img src="images/email.png" width="32" height="32" title="Invia mail"></a> <b>
				...
				<div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            <i class="fa fa-info-circle"></i>  <strong>Gestione Comunicazioni </strong>
                        </div>
                    </div>
                </div>
				                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            ...
                            <a href="ord_mail_incompleti.asp">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-yellow">
                            ...
                            <a href="ord_mail_attesapagamento.asp">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">
                                         ...
                                         <!-- Gestione Ordini presi in carico -->
                                            <%
                                        ...
                                        <div>Ordini<br> presi in carico</div>
                                    </div>
                                </div>
                            </div>
                            <a href="ord_mail_presiincarico.asp">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Ordini COMPLETI da consegnare</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    <div class="col-xs-3">
                                        ...
                                        <div>Ordini PARZIALI da consegnare</div>
                                    </div>
                                </div>
                            </div>
                            <a href="ord_storico_ordini_consegnati_risultati.asp">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Articoli Non Attivi Magazzino</div>
                                    </div>
                                </div>
                            </div>
                            <a href="ord_articoli_nonattivi.asp">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
