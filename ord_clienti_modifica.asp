  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <!--#include virtual file="include/title.asp"-->
		...
		if (document.P2.ord_nomcli.value == "")
			...
			document.P2.ord_nomcli.style.backgroundColor = 'Orange';
        ...
        if (document.P2.ord_indcli.value == "")
			{
			alert("<%=response.write (datoobbligatorio)%>");
			document.P2.ord_indcli.style.backgroundColor = 'Orange';
        ...
        if (document.P2.ord_emacli.value == "")
			{
			alert("<%=response.write (datoobbligatorio)%>");
			document.P2.ord_emacli.style.backgroundColor = 'Orange';
        ...
        if (document.P2.ord_telcli.value == "")
			{
			alert("<%=response.write (datoobbligatorio)%>");
			document.P2.ord_telcli.style.backgroundColor = 'Orange';
            ...
            <div class="row-fluid">
                   ...
                   <div class="span6" id="content">
                    <div class="row-fluid">
                       <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header"><legend>Modifica Clienti</legend></div>
