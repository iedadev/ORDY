                                 ...
                                 <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
										...
										<tbody>
											<%
                                                ...
                                                sss = "SELECT A.IDKIT,A.IDUser,A.BARCODE,A.CATEGORIA,A.SOTTOCATEGORIA,A.NOMEKIT,A.DESCKIT,C.IDPOS,A.QTA,B.IDSTATO,A.IN_OUT FROM SIM_Temp_MagicBox AS A, SIM_STATO as B, SIM_POSIZIONE as C WHERE A.STATO = B.STATO AND A.POS=C.POSIZIONE AND A.IDUser=" & iduser
                                                Response.Write sss
                                                'Response.Write rs("A.POS")
                                                'Response.end
