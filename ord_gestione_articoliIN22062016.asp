    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <% End If %>
                               ...
                               %>
                                <table class="table table-condensed">
                                 ...
                                 <%end if%>
                                    ...
                                    <div align="right">
                                    <a href="ord_gestione_movimenti.asp"><button type="button" class="btn btn-success" align="right">Ordine Completato</button></a>
                                    </div>
                                <%End if%> 
                ...
                </div><!-- nella parte laterale si potrebbe mettere Elenco dei movimenti dell'articolo--> <!-- 2016.2 utilizzare fuzniona modal per caricare il pdf-->
                <div id="pdf"><br>
