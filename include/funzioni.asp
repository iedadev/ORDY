...
Function PulisciAltro(nota)
	' Mette il campo altro in maiuscolo, ripulisce e trasforma gli "ND" in "NON DICHIARA" e altri refusi
	If IsNull(nota) Then Exit Function
	If nota = "" Then Exit Function
	nota = Trim(nota)
	nota = replace(nota, "  ", " ")
	nota = replace(nota, "à", "a'")
	nota = replace(nota, "è", "e'")
	nota = replace(nota, "é", "e'")
	nota = replace(nota, "ì", "i'")
	nota = replace(nota, "ò", "o'")
	nota = replace(nota, "ù", "u'")
	nota = UCase(nota)
	nota = replace(nota, " PIU ", " PIU' ")
	nota = replace(nota, " PERCHE ", " PERCHE' ")
	Select Case nota
		Case "ND"
			nota = "NON DICHIARA"
		Case "N/D"
		...
		Case "N.D"
			nota = "NON DICHIARA"
	End Select
	PulisciAltro = ModificaApici(nota)
End Function
