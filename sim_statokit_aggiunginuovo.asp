...
sss = "INSERT INTO SIM_Stato (Stato,DataCreated) VALUES ("&"'" & request("sim_statokit") & "',Now())"
...
sss = "SELECT MAX(IDStato) as nuovo FROM SIM_stato"
Set rs = dbConn.Execute(sss)
NuovoID = rs("nuovo")

sss = "INSERT INTO SIM_Logs (IPRemoto, Utente, Operazione, DataOperazione) VALUES ('" & IP & "', '" & session("usr") & "', 'Aggiunto Nuovo Stato " & NuovoID & "', Now())"
Set rs = dbConn.Execute(sss)
' Scrive Log - Fine
