...
sss = "INSERT INTO SIM_Logs (IPRemoto, Utente, Operazione, DataOperazione) VALUES ('" & IP & "', '" & session("usr") & "', 'Modificato Nuovo Kit da valutare " & request("IDKIT") & "', Now())"
Set rs = dbConn.Execute(sss)
' Scrive Log - Fine
...
response.redirect "sim_kit_validare.asp?IDKIT="& request("IDKIT")
%>