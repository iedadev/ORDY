...
sss1 =  "SELECT * FROM SIM_sottoCategorie as A, SIM_Categorie as B WHERE B.IDCat = " & request("IDCat") & " AND A.IDScat =" & request("IDScat")
'response.write sss
            ...
            <div class="row-fluid">
                ...
                <div class="span6" id="content">
                    <div class="row-fluid">
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header"><legend><%=response.write (titolomodificasottocategorie)%></legend></div>
                            <div class="block-content collapse in">
                                <div class="span6">
                                     ...
                                     <input type="hidden" name="IDSCat"  value="<%= rs1("IDSCat") %>">
                                      <fieldset>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput"><%=response.write (ricercacategorie)%>: </label>
                                          <div class="controls">
                                            <input value="<%= rs1("IDCat") %> (<%= rs1("Categoria") %>) " name="IDCat" readonly="readonly" class="input-xlarge focused" id="focusedInput" type="text">&nbsp;&nbsp;
                                          </div>
                                        </div>
                                           <div class="control-group">
                                          <label class="control-label" for="focusedInput"><%=response.write (ricercasottocategorie)%>: </label>
                                          <div class="controls">
                                            <input value="<%= rs1("sottocategoria") %>" name="sottocategoria" class="input-xlarge focused" id="focusedInput" type="text">&nbsp;&nbsp;
                                          </div>
                                        </div>
