            ...
            <div class="row-fluid">
                <div class="span6" id="content">
                    <div class="row-fluid">
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header"><legend><%=response.write (titolomodificasegnalazionemb)%>:<%= rs("BARCODE") & " - " & rs("NomeKit") %></legend></div>
                                     ...
                                     <input type="hidden" name="IDkit" value="<%= request("IDKit") %>">
                                      <fieldset>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <textarea class="input-xlarge textarea" name="descrizione" style="width: 450px; height: 100px"><%= rs("DESCKIT") %></textarea>
                                          </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="form-actions">
                                          <button type="submit" class="btn btn-primary tooltip-top" data-original-title="<%=response.write (etichettabottoneconferma)%>"><%=response.write (testobottoneconferma)%></button>&nbsp;
