...
sss1 = "SELECT * FROM ORD_COMPLETATI_STORICO WHERE NUMORD= " & request("cod_ord")
' response.write sss1
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                             <div class="navbar navbar-inner block-header">
                              ...
                              <form name="P2" method="post" Action="ord_gestione_ordini_dataconsegna_update.asp" class="form-horizontal" onsubmit="return controllo()">
