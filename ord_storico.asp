                    ...
                    <div class="col-lg-4 text-center">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="col-xs-9 text-center">
                                        <div class="huge">Storico Ordini Completati</div>
                                    </div>
                                </div>
                            </div>
                                </div>
                                      ...
                                      <fieldset>
                                        <div class="form-group">
                                          ...
                                          <select id="selectError" name="cod_ord" class="form-control" type="text" style="width:200px;">
                                              <option value=""></option>
                                              <%
                                             Set rs2 = dbConn.Execute("SELECT DISTINCT NUMORD FROM ORD_Completati ORDER BY NUMORD")
                                              While Not rs2.EOF
	                                              response.write "<option value='" & rs2("NUMORD") & "'>" & rs2("NUMORD") & "</option>"
		                                          'End If
                                              rs2.MoveNext
                                              Wend
                                              %>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <label  for="focusedInput">Data Ordine
                                          ...
                                          <select id="selectError" name="data_ord" class="form-control" type="text" style="width:200px;">
                                              <option value=""></option>
                                              <%
                                              Set rs1 = dbConn.Execute("SELECT Distinct DATAORDINE FROM ORD_Completati ORDER BY DATAORDINE")
                                              While Not rs1.EOF
