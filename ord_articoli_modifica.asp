...
sss1 =  "SELECT * FROM ORD_RICHIESTE WHERE CODART ='"& request("codart") &"' AND NUMORD =" & request("numord")
 'response.write sss1
'response.end
 ...
 <div class="col-lg-3 text-center">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="col-xs-9 text-center">
                                        <div class="huge">Gestione Articoli</div>
                                    </div>
                                </div>
                            </div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                             <div class="navbar navbar-inner block-header">
                            	<legend>Gestione Modifica Articoli </legend>
                            </div>
                              <form name="P2" method="post" Action="ord_articoli_modificafine.asp" class="form-horizontal" onsubmit="return controllo()">
                                     <input type="hidden" name="ord_idric"  value="<%= rs1("IDRIC") %>">
                                      <fieldset>
                                         ...
                                         <div class="form-group">
                                          ...
                                          <label  for="focusedInput"> Barcode Articolo       
                                          	<input value="<%= rs1("BARCODE") %>" name="ord_bar" class="form-control" id="focusedInput" type="text" align="center" style="width:200px;">
                                        </div></label> 

                                          <div class="form-group">
                                          <label  forord_data="focusedInput">Nome Articolo          
                                          	<input value="<%= rs1("NOMART") %>" name="ord_nom" class="form-control" id="focusedInput" type="text" align="center" style="width: 500px;">
                                        </div></label> 

                                         <div class="form-group">
                                          <label  for="focusedInput">Quantità richiesta          
                                          	<input value="<%= rs1("QTARICH") %>" name="ord_qta" class="form-control" id="focusedInput" type="text" align="center" style="width:100px;">
                                        </div></label> 

                                        <div class="form-group">
                                          <label  for="focusedInput">Data Ordine          
                                          	<input value="<%= rs1("DATAORDINE") %>" name="ord_data" class="form-control" id="focusedInput" type="text" align="center" style="width:100px;">
                                        </div></label> 
                                        <br>
