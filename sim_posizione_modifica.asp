...
sss1 =  "SELECT * FROM SIM_Posizione WHERE IDPOS = " & request("IDPOS")
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <!--#include virtual file="include/title.asp"-->
		...
		if (document.P2.posizione.value == "")
			...
			document.P2.posizione.style.backgroundColor = 'Orange';
            ...
            <div class="row-fluid">
                ...
                <div class="span6" id="content">
                    <div class="row-fluid">
                         <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header"><legend><%=response.write (titolomodificapos)%></legend></div>
                            <div class="block-content collapse in">
                                <div class="span6">
                                     <form name="P2" method="post" Action="sim_posizione_modificafine.asp" class="form-horizontal" onsubmit="return controllo()">
                                     <input type="hidden" name="IDPOS"  value="<%= rs1("IDPOS") %>">
                                      <fieldset>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput"><%=response.write (ricercaposizioni)%>: </label>
                                          <div class="controls">
                                            <input value="<%= rs1("posizione") %>" name="posizione" class="input-xlarge focused" id="focusedInput" type="text">&nbsp;&nbsp;
                                          </div>
                                        </div>
