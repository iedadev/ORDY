...
sss =  "SELECT * FROM SIM_Posizione WHERE IDPOS = " & request("IDPOS")
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                     ...
                                     <input type="hidden" name="IDPOS"  value="<%= rs("IDPOS") %>">
                                      <fieldset>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput"><%=response.write (ricercaposizioni)%>: </label>
                                          <div class="controls">
                                            <input value="<%= rs("posizione") %>" name="posizione" class="input-xlarge focused" id="focusedInput" type="text">&nbsp;&nbsp;
                                          </div>
                                        </div>
