			...
			<div class="row-fluid">
				...
				<div class="span9" id="content">
					<div class="row-fluid">
                        ...
                        <br>
                            <%If session("ruolo") = "A" Then %>
                            &nbsp;&nbsp;&nbsp;&nbsp;<a href="sim_gestione_kit.asp"><button class="btn btn-mini btn-success tooltip-top" data-original-title="Conferma nuovo kit"><i class="icon-plus icon-white"></i>Confirm New Kit</button></a>
						    &nbsp;&nbsp;&nbsp;<a href="#myAlert" data-toggle="modal"><button class="btn btn-mini btn-danger tooltip-top" data-original-title="Elimina nuovo Kit"><i class="icon-remove icon-white"></i> Delete Kit</button></a>
