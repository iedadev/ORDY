...
Set rs1 = dbConn.Execute("UPDATE HD_Iscrizioni_SummerCamp SET codTrans_esito = '" & Request("esito") & "' WHERE codTrans = '" & Request("codTrans") & "'")
%>
<!DOCTYPE html>
<html>
	<head>
		...
		<div class="container clearfix">
			...
			<article>
				<hgroup>
					...
					aver iscritto il Vostro bambino al Summer Camp Helen Doron 
					English con Arsenal Soccer Schools.<br>
