...
<html>
	<head>
		...
		<title>Modulo Iscrizione Summer Camp Arsenal - Motherwords</title>
...
//-->
	...
	<body>			
		<div class="container clearfix">
			...
			<article>
				<hgroup>
					<h2>Summer Camp con Arsenal Soccer Schools<br />Modulo di iscrizione</h2>
				</hgroup>
				<hgroup>
				...
				<hgroup>
					<h3>Settimana di Frequenza</h3>
				</hgroup>
				<select required name='ID_Sede'>
					<option value='' >Selezionare Sede e periodo</option>
					<%
					Set rs = dbConn.Execute("SELECT * FROM HD_Sedi WHERE Attivo = 'SI' And Form_Arsenal = 'SI' ORDER BY Sede")
					While not rs.eof
					%>
				...
				<label>L'iscrizione ai corsi si intende perfezionata a fronte del versamento dell'intera quota 
					di Euro 290 alla setimana, pertanto, una volta effettuato il versamento, sarà necessario inviare la ricevuta attestante tale versamento all'indirizzo: <a href="mailto:direzione@motherwords.it">segreteria@motherwords.it</a></label><br /><br />
					<label><strong>La quota include:</strong><br />pranzo, 3 ore di attività sportiva e 3 di corso di inglese, kit di benvenuto Arsenal e Helen Doron<br /><br />
				<strong>Orario: dalle 8.30 alle 16.30</strong><br /><br />
				<strong>Il Summer Camp con Arsenal Soccer Schools avrà luogo al raggiungimento del numero minimo di 20 partecipanti.</strong>
				<br /><br />
				</label>
								<hgroup>
...
.							<br />
							...
							La posa e l'utilizzo delle immagini sono da considerarsi effettuate in forma gratuità.
							<br />
							<br />
						</span> 
						</div>
					...
					<li class="check">
						...
						Art. 12 - Regolamento interno;<br />
						Art. 14 Liberatoria in relazione a riprese e uscite</div>
