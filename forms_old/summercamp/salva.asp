...
sss = sss & "', Null, Null, " & Request("ID_Programma") & ", " & Request("ID_Sede") & ", 'NO', '" &  ModificaApici(Trim(Request("commenti"))) & "')"
...
'---------------- INVIO EMAIL A SEGRETERIA ------------------------------
	...
	objMail.Subject= "Iscrizione a Summer Camp Helen Doron"
	...
	testohtml = testohtml & "<title>Motherwords - Modulo Iscrizione Summer Camp</title><link rel='stylesheet' href='main.css'><script language='JavaScript' src='jquery-1.7.2.min.js'></script><script language='JavaScript' src='jquery.blockUI.js'></script><script language='JavaScript' src='jquery.uniform.min.js'></script>"
	...
	testohtml = testohtml & "<strong>Corso:</strong> " & rs1("Sigla") & "<br>"
	testohtml = testohtml & "<strong>Fascia d'et&aacute;:</strong> " & Request("Corso_Fascia") & "<br>"
	testohtml = testohtml & "<strong>Settimana:</strong> " & rs2("sede") & "<br>" '<strong>Frequenza (Settimane):</strong> " & Request("Corso_Frequenza") & "<br>"
...
''---------------- INVIO EMAIL A Genitore ------------------------------
	...
	testohtml = testohtml & "<article><hgroup><h2><span id=':1tl' dir='ltr'>Gentile genitore,<br>grazie per aver iscritto il Vostro bambino al Summer Camp Helen Doron English.</span></h2></hgroup>"
	...
	testohtml = testohtml & "Corso: " & rs1("Descrizione") & "<br>"
	testohtml = testohtml & "Fascia d'età: " & Request("Corso_Fascia") & "<br>"
	testohtml = testohtml & "Settimana: " & rs2("Sede") & "<br>"
	testohtml = testohtml & "Pagamento: " & Request("Pagamento") & "<br><br>"
	testohtml = testohtml & "<strong>Commenti:</strong> " & Request("Commenti") & "<br>"
	testohtml = testohtml & "<h2>L'iscrizione al Summer Camp si intende perfezionata a fronte del versamento dell'intera quota di Euro 190,00 alla settimana, pertanto, una volta effettuato il pagamento, sarà necessario inviare la ricevuta attestante tale versamento all'indirizzo <a href='mailto:segreteria@motherwords.it'>segreteria@motherwords.it</a>.</h2>"
...
If request("Pagamento") = "Carta di Credito" Then
		...
		codTransh = "codTrans=529878-SC-" & Right("000000" & rs("MaxID"), 6)
		divisah = "divisa=EUR"
		importoh = "importo=19000"
		chiaveh="U529531QFpTL355885nzNk91492U66Kn5kQDWbX4"
		
		codTrans = "529878-SC-" & Right("000000" & rs("MaxID"), 6)
		divisa = "EUR"
		importo = "19000"
		alias = "payment_529878"
		mail = Request("Gen_Email")
		url_back = "http://www.motherwords.biz/forms/summercamp/ec_cancel.asp"
		languageId = "ITA"
		'urlpost = "http://www.motherwords.biz/forms/summercamp/ec_ok.asp"
		url = "http://www.motherwords.biz/forms/summercamp/ec_ok.asp"
