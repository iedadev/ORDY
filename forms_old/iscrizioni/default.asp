		...
		<div class="container clearfix">
			...
			<article>
				...
				<select required name='ID_Programma' size="1" style="height: 22px">
					...
					<%
					Set rs = dbConn.Execute("SELECT * FROM HD_Programmi WHERE Attivo = 'SI' And Form_Iscrizioni = 'SI' ORDER BY Descrizione")
					While not rs.eof
					%>
				...
				<select required name='Frequenza' size="1">
					<option value='' >Selezionare la frequenza</option>
					<option value='Monosettimanale' >Monosettimanale</option>
				...
				<br><br>
				<hgroup>
					<h3 style="height: 14px">Giorni di Frequenza</h3>
				</hgroup>
				<table>
					<tr>
						<td><input  type="checkbox" name="Lunedi">&nbsp;Lunedì</td>
						<td>&nbsp;</td>
						<td>Ore&nbsp;<input name='Lu_Ore' maxlength="5" type = "text" size="5"></td>
						<td>&nbsp;&nbsp;&nbsp;</td>
						<td><input type="checkbox" name="Giovedi">&nbsp;Giovedì</td>
						<td>&nbsp;</td>
						<td>Ore&nbsp;<input name='Gi_Ore' maxlength="5" type = "text" size="5"></td>
					</tr>
					<tr>
						<td><input type="checkbox" name="Martedi">&nbsp;Martedì</td>
						<td>&nbsp;</td>
						<td>Ore&nbsp;<input name='Ma_Ore' maxlength="5" type = "text" size="5"></td>
						<td>&nbsp;&nbsp;&nbsp;</td>
						<td><input type="checkbox" name="Venerdi">&nbsp;Venerdì</td>
						<td>&nbsp;</td>
						<td>Ore&nbsp;<input name='Ve_Ore' maxlength="5" type = "text" size="5"></td>
					</tr>
					<tr>
						<td><input type="checkbox" name="Mercoledi">&nbsp;Mercoledì</td>
						<td>&nbsp;</td>
						<td>Ore&nbsp;<input name='Me_Ore' maxlength="5" type = "text" size="5"></td>
						<td>&nbsp;&nbsp;&nbsp;</td>
						<td><input type="checkbox" name="Sabato">&nbsp;Sabato</td>
						<td>&nbsp;</td>
						<td>Ore&nbsp;<input name='Sa_Ore' maxlength="5" type = "text" size="5"></td>
					</tr>
				</table>
				<br><br>
				<hgroup>
				...
				<label>L'iscrizione ai corsi si intende perfezionata a fronte del versamento 
					della quota di preiscrizione di &euro; 100,00. Pertanto, una volta effettuato il versamento, sarà necessario inviare la ricevuta attestante tale versamento all'indirizzo: <a href="mailto:direzione@motherwords.it">segreteria@motherwords.it</a><br></label><br>
				<label><strong>Costi:</strong><br>Monosettimanale 45 minuti &euro; 670,00<br>
					Bisettimanale &euro; 840,00<br>Corso Botty, Play On, PWW, PWT (90 minuti), Jump with Joey (con workbook), More Jump with Joey &euro; 780,00<br>
					Teen Talent, Teen Choices e Teen Express (90 minuti) &euro; 840,00<br>Questi 
					corsi comprendono la preparazione agli esami Cambridge Young 
					Learners<br><br>
				</label>
				<hgroup>
					<h3 style="height: 14px">Come intendete pagare la quota di iscrizione di &#8364; 100,00?</h3>
				</hgroup>
