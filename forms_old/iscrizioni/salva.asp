...
sss = sss & "', Null, Null, " & Request("ID_Programma") & ", Null)"
...
''---------------- INVIO EMAIL A Genitore ------------------------------
	...
	testohtml = testohtml & "<h2>Ricordiamo che l'iscrizione verrà considerata valida solo dopo il pagamento dell'acconto di Euro 100,00.</h2>"
