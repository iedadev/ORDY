...
Set rs1 = dbConn.Execute("UPDATE CB_iscrizioni SET codTrans_esito = '" & Request("esito") & "' WHERE codTrans = '" & Request("codTrans") & "'")
%>
<!DOCTYPE html>
<html>
	<head>
		...
		<div class="container clearfix">
			...
			<article>
				<hgroup>
					...
					aver iscritto il Vostro bambino all'Esame Cambridge di Helen Doron English.<br>
