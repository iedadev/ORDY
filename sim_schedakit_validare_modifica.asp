            ...
            <div class="row-fluid">
                <div class="span12" id="content">
                    <div class="row-fluid">
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header"><legend>Modifica Kit da Valutare Barcode: <%= rs("BARCODE") & " - name Kit: " & rs("NomeKit") %></legend></div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                     <form name="P2" method="post" Action="sim_schedakit_validare_modificafine.asp" class="form-horizontal" onsubmit="return controllo()">
