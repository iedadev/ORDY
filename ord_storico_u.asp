...
s =  "SELECT DISTINCT numord, DataOrdine FROM ORD_COMPLETATI_STORICO WHERE LC ='" & session("usr") & "'" 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                             ...
                             <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                      ...
                                      <td>
												<a href="ord_storico_ordini_articoli.asp?nrordine=<%=rs("Numord")%>"><i class="fa fa-list-alt fa-2x"></i></a>
												</td>	
												</tr>
											<%
											rs.MoveNext 
